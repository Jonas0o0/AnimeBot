...
class ReportModal(discord.ui.Modal, title="Send us your bug"):
    ...
    fbt_tile = discord.ui.TextInput(
        ...
        label="Title",
        required=True,
        placeholder="Give a title for your bug"
    )
    message = discord.ui.TextInput(
        ...
        required=True,
        max_length=1000,
        placeholder="Give a description/explication for your bug"
    )

    async def on_submit(self, interaction: discord.Interaction) -> None:
        channel = interaction.guild.get_channel(config.SUGESTION_CH)
